...
*/
    io.key_map[GuiKey.Tab]        = i32(input.VirtualKey.Tab);
    io.key_map[GuiKey.LeftArrow]  = i32(input.VirtualKey.Left);
    io.key_map[GuiKey.RightArrow] = i32(input.VirtualKey.Right);
    io.key_map[GuiKey.UpArrow]    = i32(input.VirtualKey.Up);
    io.key_map[GuiKey.DownArrow]  = i32(input.VirtualKey.Down);
    io.key_map[GuiKey.PageUp]     = i32(input.VirtualKey.Next);
    io.key_map[GuiKey.PageDown]   = i32(input.VirtualKey.Prior);
    io.key_map[GuiKey.Home]       = i32(input.VirtualKey.Home);
    io.key_map[GuiKey.End]        = i32(input.VirtualKey.End);
    io.key_map[GuiKey.Delete]     = i32(input.VirtualKey.Delete);
    io.key_map[GuiKey.Backspace]  = i32(input.VirtualKey.Back);
    io.key_map[GuiKey.Enter]      = i32(input.VirtualKey.Return);
    io.key_map[GuiKey.Escape]     = i32(input.VirtualKey.Escape);
