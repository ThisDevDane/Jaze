...
load_functions :: proc() {
    lib := misc.load_library("opengl32.dll"); defer misc.free_library(lib);
    set_proc_address :: proc(lib : misc.LibHandle, p: rawptr, name: string) #inline {
        res := gl.get_proc_address(name);
        if res == nil {
