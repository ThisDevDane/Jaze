...
foreign cimgui {
    // Clipping
    push_clip_rect :: proc(clip_rect_min : Vec2, clip_rect_max : Vec2, intersect_with_current_clip_rect : bool) #link_name "igPushClipRect" ---;
    pop_clip_rect  :: proc()                                                                                    #link_name "igPopClipRect"  ---;
...
foreign cimgui {
    begin_child_frame :: proc(id : GuiId, size : Vec2, extra_flags : GuiWindowFlags) -> bool #link_name "igBeginChildFrame" ---;
    end_child_frame   :: proc  ()                                                            #link_name "igEndChildFrame"   ---;
