...
text_disabled   :: proc(fmt_: string, args: ..any) {
    im_text_disabled :: proc(fmt_ : ^byte) #foreign cimgui "igTextDisabled";
...
tree_node :: proc(ptr_id : rawptr, fmt_ : string, args : ..any) -> bool {
    im_tree_node_ptr :: proc(ptr_id : rawptr, fmt_ : ^byte) -> bool #foreign cimgui "igTreeNodePtr";
...
tree_node_ex :: proc(ptr_id : rawptr, flags : GuiTreeNodeFlags, fmt_ : string, args : ..any) -> bool {
    im_tree_node_ex_ptr :: proc(ptr_id : rawptr, flags : GuiTreeNodeFlags, fmt_ : ^byte) -> bool #foreign cimgui "igTreeNodeExPtr";
...
set_tooltip :: proc(fmt_ : string, args : ..any) {
    im_set_tooltip :: proc(fmt : ^byte) #foreign cimgui "igSetTooltip"; 
...
log_text :: proc(fmt_ : string, args : ..any) {
    im_log_text :: proc(fmt_ : ^byte) #foreign cimgui "igLogText";
